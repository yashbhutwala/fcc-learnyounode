...
Both `bl` and `concat-stream` can have a stream _piped_ in to them and they will collect the data for you. Once the stream has ended, a callback will be fired with the data:
