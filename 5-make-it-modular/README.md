...
Create a new module by creating a new file that just contains your directory reading and filtering function. To define a _single function_ _export_, you assign your function to the `module.exports` object, overwriting what is already there:
